...
export const EventManagement = () => {
  ...
  const NovelData = () => {
    ...
    document.querySelector(".loaderBox").classList.remove("d-none");
    fetch(
      "https://custom.mystagingserver.site/Tim-WDLLC/public/api/novel_category_listing",
      {
        method: "GET",
        headers: {
          Accept: "application/json",
  ...
  const removeItem = (catId) => {
    ...
    document.querySelector(".loaderBox").classList.remove("d-none");
    fetch(
      `https://custom.mystagingserver.site/Tim-WDLLC/public/api/admin/delete_category/${catId}`,
      {
        method: "POST",
        headers: {
          Accept: "application/json",
