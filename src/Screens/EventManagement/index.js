...
export const EventManagement = () => {
  ...
  useEffect(() => {
    document.title = 'Hisoc Admin | Event Management';
    bookData()
  ...
  const removeItem = (catId) => {
    const LogoutData = localStorage.getItem('login');
    document.querySelector('.loaderBox').classList.remove("d-none");
    fetch(`https://custom.mystagingserver.site/Tim-WDLLC/public/api/admin/delete_category/${catId}`,
      {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
                ...
                <div className="row mb-3 justify-content-between">
                  ...
                  <div className="col-md-6 mb-2">
                    <div className="addUser">
                      <CustomButton text="Add New Event" variant='primaryButton' onClick={hanldeRoute} />
